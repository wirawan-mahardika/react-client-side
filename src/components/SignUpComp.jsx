...
export default function SignUpComp() {
    ...
    return (
      <div className="flex justify-center p-5 pt-0 rounded-lg bg-slate-300 w-3/5 mx-auto">
        <form
          onSubmit={submit}
          className="flex flex-col mt-12 border-none p-8 pt-5 w-1/2 bg-slate-100 rounded-lg"
        >
          ...
          <div className="font-bold text-lg flex flex-col gap-y-1">
            ...
            <input
              ...
              className="outline-none rounded bg-slate-100 px-3 py-0.5 ring-2 focus:ring-cyan-500"
            />
          </div>
          <div className="font-bold text-lg flex flex-col gap-y-1">
            <label>Email</label>
          ...
          <button
            className="px-3 py-0.5 w-fit rounded bg-sky-500 mx-auto"
            type="submit"
          >
