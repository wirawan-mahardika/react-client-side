...
import image1 from '../img/komputer-1.jpg'
...
export default function Detail() {
    ...
    const addCart = () => {
        dispatch(addToCart({name: state.name, price: state.price, jumlah: jumlah}))
    }
    ...
    return (
        <>
            ...
            <div className="bg-gray-200 w-2/5 flex flex-col h-screen left-0 p-6 opacity-100 fixed z-20 top-0 overscroll-y-auto">
                <button onClick={() => navigate(-1)} className='absolute right-0 mr-2 hover:text-red-500 top-0 font-bold text-lg p-1'>X</button>
                <img src={image1} alt="image1" className='w-full mt-3' />
                <div className='flex flex-col gap-y-3 p-4'>
                    ...
                    <div className='flex gap-2 justify-between p-5'>
                        ...
                        <div className='flex flex-col gap-y-2'>
                            ...
                            <button onClick={addCart} className='px-3 py-1 rounded font-semibold bg-sky-500 w-fit'>Beli</button>
                        </div>
                    </div>
                </div>
            </div>
